    ...
    <div id="container" ref="container" style="width: 100%; height: 10rem; background-color: #000"
      ...
      <div class="buttons-box" id="buttonsBox">
        <div class="buttons-box-left">
          <i v-if="!playing" class="el-icon-video-play jessibuca-btn" @click="playBtnClick"></i>
          <i v-if="playing" class="el-icon-video-pause jessibuca-btn" @click="pause"></i>
          <i class="el-icon-switch-button jessibuca-btn" @click="destroy"></i>
          <i v-if="isNotMute" class="icon-shengyin jessibuca-btn" @click="jessibuca.mute()"></i>
          <i v-if="!isNotMute" class="icon-shengyinguanbi jessibuca-btn" @click="jessibuca.cancelMute()"></i>
        </div>
        <div class="buttons-box-right">
          ...
          <i v-if="!fullscreen" class="icon-quanping jessibuca-btn" @click="fullscreenSwich"></i>
          <i v-if="fullscreen" class="icon-tuichuquanping jessibuca-btn" @click="fullscreenSwich"></i>
        </div>
      </div>
