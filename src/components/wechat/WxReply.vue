...
<template>
  <el-tabs type="border-card" v-model="objData.repType" @tab-click="handleClick">
    <el-tab-pane name="text">
      ...
      <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="objData.repContent">
      </el-input>
    </el-tab-pane>
        ...
        <div v-if="!objData.repUrl">
          <el-row style="text-align: center">
            ...
            <el-col :span="12" class="col-add">
              <el-upload :action="actionUrl" :headers="headers" multiple :limit="1" :on-success="handleUploadSuccess" :file-list="fileList"
      ...
      <el-row>
        ...
        <div v-if="!objData.repName">
          <el-row style="text-align: center">
            ...
            <el-col :span="12" class="col-add">
              <el-upload :action="actionUrl" :headers="headers" multiple :limit="1" :on-success="handleUploadSuccess" :file-list="fileList"
                         :before-upload="beforeVoiceUpload" :data="uploadData">
    ...
    <el-tab-pane name="video">
      ...
      <el-row>
        ...
        <div style="text-align: center;">
          <a target="_blank" v-if="objData.repUrl" :href="objData.repUrl"><i class="icon-bofang">&nbsp;播放视频</i></a>
        </div>
        <div style="margin: 20px 0;"></div>
        <div style="text-align: center">
          <el-button type="success" @click="openMaterial">素材库选择<i class="el-icon-circle-check el-icon--right"></i>
