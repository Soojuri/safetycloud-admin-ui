    ...
    <div class="g-card">
      <el-form ref="queryParams" :model="queryParams" inline>
        <el-form-item label="设备编号" prop="deviceNo" :rules="[$formRules.checkLen()]">
          <el-input v-model.trim="queryParams.deviceNo" placeholder="请输入设备编号"
                    @keyup.native="trimInput(queryParams,'deviceNo')"></el-input>
        </el-form-item>
        <el-form-item label="设备名称" prop="deviceName" :rules="[$formRules.checkLen()]">
          <el-input v-model.trim="queryParams.deviceName" placeholder="请输入设备名称"
                    @keyup.native="trimInput(queryParams,'deviceName')"></el-input>
        </el-form-item>
