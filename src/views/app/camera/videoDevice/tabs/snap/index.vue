...
<template>
  <div class="sub-page">
    <div class="g-card">
      ...
      <div class="mt-m clearfix" v-if="tableData.length>0">
        <div class="ml-m snap-image" v-for="item in tableData" :key="item.captureId">
          <el-image style="width: 100%; height: 150px" :src="imagePath + item.captureUrl" fit="cover"
                    :preview-src-list="[imagePath + item.captureUrl]">
          </el-image>
