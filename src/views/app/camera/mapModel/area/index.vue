...
<template>
  <div class='sub-page'>
    <div class="g-card">
      ...
      <!-- 表格数据 -->
      <el-table :data="tableData" border row-key="id" v-loading="loading" :tree-props="{children: 'children', hasChildren: 'hasChildrens'}">
    ...
    <data-form v-if="dataForm.visible" :visible.sync="dataForm.visible" :data="dataForm.data" :type="dataForm.type" @ok="getList"></data-form>
  </div>
</template>
