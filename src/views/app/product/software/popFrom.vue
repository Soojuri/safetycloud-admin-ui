      ...
      <el-row>
        <el-col :offset="3" :span="16">
          <el-form :rules="rules" :model='form' label-width='120px' ref='form'>
            ...
            <el-form-item label="产品子类" prop="algorithmCategory">
              <el-select v-model="form.algorithmCategory" placeholder="请选择产品子类">
                <el-option v-for="item in dict.algorithmCategory" :label="item.label" :value="parseInt(item.value)"
                           :key="item.value">
                </el-option>
              </el-select>
            </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        algorithmCategory: [this.$formRules.checkNecessary('请选择产品子类')],
