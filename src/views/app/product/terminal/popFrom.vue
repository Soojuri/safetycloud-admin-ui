        ...
        <el-col :offset="3" :span="16">
          <el-form :rules="rules" :model='form' label-width='120px' ref='form'>
            ...
            <el-form-item label="产品分类" prop="productType">
              <el-input size='small' placeholder='请输入产品描述' value='传感器终端' disabled='true'></el-input>
              <!-- <el-select disabled='true' v-model="form.productType" value-key='' placeholder="请选择产品分类">
                <el-option label="传感器终端" :value="2" :key="2">
                </el-option>
              </el-select> -->
            </el-form-item>
            <el-form-item label="产品子类" prop="deviceCategory">
              <el-select v-model="form.deviceCategory" placeholder="请选择产品子类">
                <el-option v-for="item in dict.deviceCategory" :label="item.label" :value="parseInt(item.value)"
                           :key="item.value">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item label='产品价格' prop='productPrice'>
              <el-input size='small' v-model='form.productPrice' placeholder='请输入产品价格，单位元'></el-input>
            </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        deviceCategory: [this.$formRules.checkNecessary('请选择产品子类')],
