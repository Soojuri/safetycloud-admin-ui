  ...
  <div class="jobLog">
    <basic-container>
      <el-dialog :visible.sync="dialogFormVisible" title="执行日志" width="90%" @close="closeJobLogDialog">
        <avue-crud ref="crudLog" :page.sync="pageLog" :data="tableLogData" :option="tableLogOption" :table-loading="tableLogLoading"
                   @on-load="getJobLogList" @size-change="sizeChange" @current-change="currentChange" @refresh-change="getJobLogList">
        </avue-crud>
      </el-dialog>
    </basic-container>
  </div>
