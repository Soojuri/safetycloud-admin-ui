<template>
  <!-- 添加或修改菜单对话框 -->
  <el-dialog :title="!form.menuId ? '新增': '修改'" :close-on-click-modal="false" :visible.sync="visible">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        sort: [this.$formRules.checkLen(), { required: true, message: '菜单顺序不能为空', trigger: 'blur' }],
